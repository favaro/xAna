...
double TEvtProb::XsecCalcXJJ(TVar::Process proc, TLorentzVector p4[3], TVar::VerbosityLevel verbosity){
 ...
 // 0- H2j
      if ( proc == TVar::HJJNONVBF_PS ) {
      Hggcoupl[0][0]=0.0;  Hggcoupl[0][1]=0.0;
      Hggcoupl[1][0]=0.0;  Hggcoupl[1][1]=0.0;  
      Hggcoupl[2][0]=1.0;  Hggcoupl[2][1]=0.0; 
      }

 // 0- VBF
      if ( proc == TVar::HJJVBF_PS ) {
      Hvvcoupl[0][0]=0.0;  Hvvcoupl[0][1]=0.0;  
      Hvvcoupl[1][0]=0.0;  Hvvcoupl[1][1]=0.0;  
      Hvvcoupl[2][0]=0.0;  Hvvcoupl[2][1]=0.0;  
      Hvvcoupl[3][0]=0.0;  Hvvcoupl[3][1]=1.0;  
      }

 // VBF ANOMALOUS
      if ( proc == TVar::HJJVBF_BSM ) {
      Hvvcoupl[0][0]=0.0;  Hvvcoupl[0][1]=0.0;  
      Hvvcoupl[1][0]=1.0;  Hvvcoupl[1][1]=0.0;  
      Hvvcoupl[2][0]=0.0;  Hvvcoupl[2][1]=0.0;  
      Hvvcoupl[3][0]=0.0;  Hvvcoupl[3][1]=0.0;   
      }
