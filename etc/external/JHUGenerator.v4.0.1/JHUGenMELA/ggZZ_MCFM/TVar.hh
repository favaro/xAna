...
public:
  ...
  enum Process{
    ...
    HZZ_4l_MIXCP = 17,
    HJJNONVBF = 18,       // H+2j gg 0+
    HJJVBF = 19,          // H+2j VBF 0+
    HJJNONVBF_PS = 20,    // H+2j gg 0-
    HJJVBF_PS = 21,       // H+2j VBF 0- 
    HJJVBF_BSM = 22,      // VBF Anomalous 0+
    Null
  };
  enum LeptonFlavor{
  ...
  static TString ProcessName(int temp){ 
    ...
    else if(temp==TVar::HJJNONVBF_PS ) 
      return TString("HJJNONVBF_PS");
    else if(temp==TVar::HJJVBF_PS ) 
      return TString("HJJVBF_PS");
    else if(temp==TVar::HJJVBF_BSM ) 
      return TString("HJJVBF_BSM");
    else 
