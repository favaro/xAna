#ifndef photonScaleSmearing_hh__
#define photonScaleSmearing_hh__

#include <vector>
#include <string>


class photonEnergyScale {
 public:
  photonEnergyScale( void );
  ~photonEnergyScale(void);
...
class photonEnergySmearing {
 public:
  ...
  photonEnergySmearing::category photonEnergySmearingCategory( float scEta, float r9, bool isEBGap );
